...
def loadSamples():
	...
	for elem3 in samples2:
		...
		comando = "elasticsearch_loader --es-host http://caoba-access.virtual.uniandes.edu.co:8083 --index sample_"+str(elem3)+"_3 --type basicdata csv /Users/JCAMILORT/Developer/esexploration/elasticSearchExperiments/enapp/data/scrip_generator/sample_"+str(elem3)+".txt"
		os.system(comando)
	for elem5 in samples2:
		print('Loading 5-samples...'+str(elem5))
		comando = "elasticsearch_loader --es-host http://caoba-access.virtual.uniandes.edu.co:8083 --index sample_"+str(elem5)+"_5 --type basicdata csv /Users/JCAMILORT/Developer/esexploration/elasticSearchExperiments/enapp/data/scrip_generator/sample_"+str(elem5)+".txt"
		os.system(comando)
