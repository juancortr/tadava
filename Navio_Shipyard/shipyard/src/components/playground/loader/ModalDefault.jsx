...
const ModalDefault = ({ visible, datasets, confirmLoading, remotedatasets, showModal, handleOk, handleCancel, setData, toggleLoading, toggleDataLoaded, setComponentClasses }) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <p> ------ Or chooose a remote dataset ------</p><br></br>
        <Row>
        {
...
const mapStateToProps = state => ({
  ...
  remotedatasets: state.shipyard.remotedatasets,
});
