...
const initialState = {
  ...
  remotedatasets:[
    {
      id: 4,
      title: 'ElasticSearch Sample 1M',
      description: 'Elasticsearch generated data',
      index: 'sample_10000000_module',
      size: '3.4gb',
      n_attributes: 8,
      URL: 'http://157.253.236.37:8083/sample_10000000_module?=pretty',
    }
  ],
};
const shipyard = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CHANGE_TYPE_STATUS:
      const attrs2 = JSON.parse(JSON.stringify(state.attributes));
